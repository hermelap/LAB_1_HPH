...
def M_A(df, MA_Slow, MA_Fast):

    """
    :param df: Dataframe con los datos de la accion
    :param MA_Slow: Ventana del promedio movil lento
    :param MA_Fast: Ventana del promedio movil rapido
    :return: Dataframe concatenando los promedios moviles
    """
...
def decision(df, MA_Slow, MA_Fast):
    """
    :param df: Dataframe con los datos de la accion
    :param MA_Slow: Ventana del promedio movil lento
    :param MA_Fast: Ventana del promedio movil rapido
    :return: Imprime comprar, vender o mantener
    """
    df = M_A(df,MA_Slow=MA_Slow, MA_Fast=MA_Fast)
